...
'''
1. Reads: 
  * saved weights      from run/vae/0002/digits/weights/weights.h5
  * saved architecture from run/vae/0002_digits/params.pkl
2. Reconstructs 10 images
3. Plots the 10 images
4. Plots the latent space
...
from generator.loaders import load_mnist, load_model
# run params
SECTION = 'vae'
RUN_ID = '0002'
DATA_NAME = 'digits'
